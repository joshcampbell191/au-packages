...
$Options = [ordered]@{
    ...
    Report = @{
        ...
        Params= @{                                          #Report parameters:
            ...
            UserMessage = "[Ignored](#ignored) | [History](#update-history) [Force Test](https://gist.github.com/$Env:gist_id_test) | [Releases](https://github.com/$Env:gh_user_repo/tags) | [![AU Packages](https://img.shields.io/github/actions/workflow/status/$Env:gh_user_repo/.github%2Fworkflows%2Fau-packages.yml?logo=github&label=AU%20Packages)](https://github.com/$Env:gh_user_repo/actions/runs/$Env:gh_run_id)"       #  Markdown, Text: Custom user message to show
