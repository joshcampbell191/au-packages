...
$Options = [ordered]@{
    ...
    Report = @{
        ...
        Params= @{                                          #Report parameters:
            ...
            UserMessage = "[Ignored](#ignored) | [History](#update-history) | [![AU Packages](https://github.com/$Env:gh_user_repo/actions/workflows/au-packages.yml/badge.svg)](https://github.com/$Env:gh_user_repo/actions/runs/$Env:gh_run_id) | [Force Test](https://gist.github.com/$Env:gist_id_test) | [Releases](https://github.com/$Env:gh_user_repo/tags)"       #  Markdown, Text: Custom user message to show
