...
$options = [ordered]@{
    ...
    Report = @{
        ...
        Params= @{                                          #Report parameters:
            ...
            UserMessage = "[Ignored](#ignored) | [Update report](https://gist.github.com/$Env:gist_id) | [![AU Packages Force Test](https://img.shields.io/github/actions/workflow/status/$Env:gh_user_repo/.github%2Fworkflows%2Fau-packages-force-test.yml?logo=github&label=AU%20Packages%20Force%20Test)](https://github.com/$Env:gh_user_repo/actions/runs/$Env:gh_run_id)"       #  Markdown, Text: Custom user message to show
        }
    }
